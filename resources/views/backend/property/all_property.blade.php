                  ...
                  <table id="dataTableExample" class="table">
                   ...
                   @foreach($property as $key => $item)
                      <tr>
                        ...
                        <td>{{ $item['type']['type_name'] }}</td> <!--type is a function in Property controller that returns $this=(Ptype struct), we access type_name of $this from the property_types table-->
