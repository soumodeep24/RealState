        ...
        <div class="col-sm-6">
            <div class="form-group mb-3">
               ...
               <select name="property_status" class="form-select" id="exampleFormControlSelect1">
                ...
                <option value="buy" {{ $property->property_status == 'buy' ? 'selected' : '' }}>Buy</option> 
            </select>
            </div>
        </div><!-- Col -->
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> 
            <input type="file" class="form-control" name="multi_img[{{ $img->id }}]"> <!--pass image id to controller to unlink old image and update new image to this id in the Multi images table-->
            </td>
            <td>
...
<div class="row add_item">
        @if ($facilities->isEmpty())
            <!-- Render one empty row if no facilities exist -->
