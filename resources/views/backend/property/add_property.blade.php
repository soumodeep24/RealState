    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <a href="https://www.latlong.net/" target="_blank">Get Latitude & Longitude of address</a>
            </div>
        </div><!-- Col -->
        <div class="col-sm-6">
            <div class="mb-3">
        ...
        <div class="col-sm-3">
            <div class="mb-3">
               ...
               @foreach($propertytype as $ptype)
                <option value="{{ $ptype->id }}">{{ $ptype->type_name }}</option> <!--All existing types-->
               @endforeach
            </select>
            </div>
        </div><!-- Col -->
...
<input type="checkbox" name="hot" value="1" class="form-check-input" id="checkInline">
        ...
        <div class="row add_item">
                ...
                <div class="col-md-4">  <!--  Distance to the Facilities   -->
                    <div class="mb-3">
...
<div style="visibility: hidden"> <!--Visible atleast when one item added-->
...
<script type="text/javascript">  // Check if empty value passed to add Property,
    $(document).ready(function (){
        $('#myForm').validate({
            rules: {
                property_name: { 
...
<script type="text/javascript"> //single image thumb
...
<script> 
 ...
 $(document).ready(function(){     // Multiple images
